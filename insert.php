...
{
    $errors[] = 'Die Genre-Liste konnte nicht geladen werden: ' . $e->getMessage();
}
...
$pageTitle = 'Neues Buch hinzufügen';
...
<section class="hero">
    ...
    <p class="subtitle">
        Daten des neu hinzuzufügenden Buches eingeben.
    </p>
...
<section class="form-card">
    ...
    <form class="book-form" method="post" action="">
        ...
        <div class="form-actions">
            <button class="btn btn-primary" type="submit">Buch speichern</button>
